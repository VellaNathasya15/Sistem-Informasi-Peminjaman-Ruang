...
<ul>
	...
	<li <?php if($hal == "Kelola Data Inventory") echo "class='active'"; ?>>
		<a href="<?php echo base_url('dashboard/data-inventory'); ?>"><!-- <span class="lnr lnr-database"></span> -->Data Inventory</a>
	</li>
